...
SearchForm = function(){
	...
	*/
	this.search = function(){
		...
		addVal('IndividualName', "#contact");
		addVal('MdIndividualName', "#mdcontact");
        addVal('IsPublic', "#md-status");
        addVal2('Subject', "#geology", "uri");
        addVal2('Subject', "#gemet", "text");
        addVal('MetadataCountry', "#country");
        addVal('LinkName', "#datatype", 'like');
        addVal('ServiceType', "#apptype", 'like');
	...
	*/
	...
	var addVal = function(key, s, like){
