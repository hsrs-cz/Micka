...
<xsl:template match="/">
  ...
  <csw:SchemaComponent parentSchema="gmd.xsd" 
    ...
    <xs:schema 
    	...
    	targetNamespace="http://www.isotc211.org/2005/gmd" elementFormDefault="qualified" version="0.1">
      <!-- ================================= Annotation ================================ -->
      ...
      <xs:include schemaLocation="http://schemas.opengis.net/iso/19139/20060504/gmd/constraints.xsd" />
      <xs:include schemaLocation="http://schemas.opengis.net/iso/19139/20060504/gmd/distribution.xsd" />
      <xs:include schemaLocation="http://schemas.opengis.net/iso/19139/20060504/gmd/maintenance.xsd" />
  ...
  <csw:SchemaComponent targetNamespace="http://www.opengis.net/cat/csw/2.0.2" schemaLanguage="http://www.w3.org/XML/Schema" >
	<xsl:copy-of select="document('http://schemas.opengis.net/csw/2.0.2/CSW-discovery.xsd')"/>
  </csw:SchemaComponent>
