...
<request verb="ListIdentifiers" metadataPrefix="oai_marc" from="{$FROM}">
  <xsl:value-of select="$thisURL"/>/oai.php
	...
	<xsl:template match="rec/gmd:MD_Metadata" xmlns="http://www.openarchives.org/OAI/2.0/" xmlns:gmd="http://www.isotc211.org/2005/gmd" >
	    <header>
