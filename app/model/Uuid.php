<?php
/* Copyright 2006 Wez Furlong.
 * Copyright 2006 OmniTI Computer Consulting Inc.
 * This source code is free to use provided that this copyright header
 * is preserved in all copies of the source code.
 *
 * Edit hsrs
 *	$this->arr_data
 * */
...
class UUID {
	...
	function generate() {
		...
		// new
		$this->arr_data['tl'] = $time_lo;
		$this->arr_data['tm'] = $time_mid & 0xffff;
		$this->arr_data['th'] = $time_hi;
		$this->arr_data['ch'] = $clock_hi;
		$this->arr_data['cl'] = $clock_lo;
		$this->arr_data['nl'] = $node_lo;
		$this->arr_data['n'] = $node;
