...
<xsl:for-each select="wfs:FeatureCollection/gml:featureMember/ms:nuts3">
<tr><td><a href="javascript:gazBbox('{normalize-space(translate(gml:boundedBy/gml:Box/gml:coordinates,',',' '))}');"><xsl:value-of select="ms:NURGNM"/></a> (<xsl:value-of select="ms:NURGCDL0"/>)</td></tr>
</xsl:for-each>
