...
<xsl:for-each select="wfs:FeatureCollection/gml:featureMember/ms:okresy">
<tr><td><a href="javascript:gazBbox('{normalize-space(translate(gml:boundedBy/gml:Box/gml:coordinates,',',' '))}');"><xsl:value-of select="ms:NAZOK"/></a></td></tr>
</xsl:for-each>
