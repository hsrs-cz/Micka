...
<xsl:for-each select="wfs:FeatureCollection/gml:featureMember/ms:kraje">
<tr><td><a href="javascript:gazBbox('{normalize-space(translate(gml:boundedBy/gml:Box/gml:coordinates,',',' '))}');"><xsl:value-of select="ms:KRAJ_NAZEV"/></a></td></tr>
</xsl:for-each>
</xsl:template>
