...
<xsl:for-each select="wfs:FeatureCollection/gml:featureMember/ms:nuts1">
<tr><td><a href="javascript:gazBbox('{normalize-space(translate(gml:boundedBy/gml:Box/gml:coordinates,',',' '))}');"><xsl:value-of select="ms:ARRGCDL0"/></a> (<xsl:value-of select="ms:ARRGCDL0"/>)</td></tr>
</xsl:for-each>
