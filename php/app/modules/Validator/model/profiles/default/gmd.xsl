...
<test code="8.2" id="4710,4872">
    ...
    <xsl:if test="gmd:identificationInfo/*/gmd:resourceConstraints[*/gmd:accessConstraints/*/@codeListValue='otherRestrictions']/*/gmd:otherConstraints[contains(*/@xlink:href,'http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess')]/*/@xlink:href">
            <value> 
                <xsl:value-of select="gmd:identificationInfo/*/gmd:resourceConstraints[*/gmd:accessConstraints/*/@codeListValue='otherRestrictions']/*/gmd:otherConstraints[contains(*/@xlink:href,'http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess')]/*/@xlink:href"/>
               - <xsl:value-of select="gmd:identificationInfo/*/gmd:resourceConstraints[*/gmd:accessConstraints/*/@codeListValue='otherRestrictions']/*/gmd:otherConstraints[contains(*/@xlink:href,'http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess')]/*"/>
            </value>
            <pass>true</pass>
    </xsl:if>
</test>
...
<!-- 9.1.d -->
<test code="9.1d" id="5032" level="c">
...
<!-- 10.1.d -->
<test code="10.1d" id="124" level="c">
...
<xsl:if test="not($srv)">
    ...
    <test code="IOD-6" id="105" level="m">
